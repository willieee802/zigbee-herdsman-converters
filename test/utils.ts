...
import {Device, Endpoint} from "@willieee802/zigbee-herdsman/dist/controller/model";
import {InterviewState} from "@willieee802/zigbee-herdsman/dist/controller/model/device";
...
function mockEndpoint(args: MockEndpointArgs, device: Zh.Device | undefined) {
    ...
    const endpoint: Endpoint = new Endpoint(
        ...
        device?.ieeeAddr ?? "0x0000000000000000",
        args.attributes ?? {},
        [],
        [],
        args.meta,
