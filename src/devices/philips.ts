...
const definitions: Definition[] = [
  ...
  },
  {
    ...
    fromZigbee: [
      fz.battery,
      fz.hue_wall_switch_device_mode,
      fz.hue_wall_switch,
      fz.command_toggle,
      fz.command_move,
      fz.command_stop,
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await endpoint2.write(
        "genBasic",
        { 0x0031: { value: 0x000b, type: 0x19 } },
        options
      );
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      legacy.fz.SmartButton_skip,
      fz.hue_smart_button_event,
      fz.battery,
    ],
    toZigbee: [],
    exposes: [
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .binary("led_indication", ea.ALL, true, false)
        .withDescription("Blink green LED on motion detection"),
      e
    ...
    toZigbee: [
      ...
      philipsTz.hue_motion_sensitivity,
      philipsTz.hue_motion_led_indication,
    ],
    endpoint: (device) => {
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await endpoint.read("msOccupancySensing", [48], {
        manufacturerCode: Zcl.ManufacturerCode.SIGNIFY_NETHERLANDS_B_V,
      });
    },
    ota: ota.zigbeeOTA,
  ...
  },
  {
    ...
    exposes: [
      ...
      e.illuminance_lux(),
      e.illuminance(),
      e.enum("motion_sensitivity", ea.ALL, [
        "low",
        "medium",
        "high",
        "very_high",
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .enum("action_direction", ea.STATE, ["right", "left"])
        .withDescription("Direction in which the dial was turned"),
      e
  ...
  {
    fingerprint: [
      { modelID: "GreenPower_2", ieeeAddr: /^0x00000000004.....$/ },
    ],
    model: "8718696743133",
    vendor: "Philips",
    description: "Hue tap",
