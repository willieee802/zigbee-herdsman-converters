  ...
  thermostat: {
    ...
    convert: (model, msg, publish, options, meta) => {
      ...
      if (msg.data.hasOwnProperty("1024")) {
        result.thermostat_occupancy = utils.getFromLookup(
          msg.data["1024"],
          occupancyLookup
        );
      }
      if (msg.data.hasOwnProperty("SinopeOccupancy")) {
        result.thermostat_occupancy = utils.getFromLookup(
          msg.data["SinopeOccupancy"],
          occupancyLookup
        );
      }
      if (msg.data.hasOwnProperty("1025")) {
        result.main_cycle_output = utils.getFromLookup(
          msg.data["1025"],
          cycleOutputLookup
        );
      }
      if (msg.data.hasOwnProperty("SinopeMainCycleOutput")) {
        result.main_cycle_output = utils.getFromLookup(
          msg.data["SinopeMainCycleOutput"],
          cycleOutputLookup
        );
      }
      if (msg.data.hasOwnProperty("1026")) {
        const lookup = { 0: "on_demand", 1: "sensing" };
        result.backlight_auto_dim = utils.getFromLookup(
          msg.data["1026"],
          lookup
        );
      }
      if (msg.data.hasOwnProperty("SinopeBacklight")) {
        const lookup = { 0: "on_demand", 1: "sensing" };
        result.backlight_auto_dim = utils.getFromLookup(
          msg.data["SinopeBacklight"],
          lookup
        );
      }
      if (msg.data.hasOwnProperty("1028")) {
        result.aux_cycle_output = utils.getFromLookup(
          msg.data["1028"],
          cycleOutputLookup
        );
      }
      if (msg.data.hasOwnProperty("localTemp")) {
        result.local_temperature =
          precisionRound(msg.data["localTemp"], 2) / 100;
      }
      ...
      if (msg.data.hasOwnProperty("outdoorTemp")) {
        result.outdoor_temperature =
          precisionRound(msg.data["outdoorTemp"], 2) / 100;
      }
      ...
      if (msg.data.hasOwnProperty("ctrlSeqeOfOper")) {
        result.control_sequence_of_operation =
      ...
      if (msg.data.hasOwnProperty("systemMode")) {
        result.system_mode =
          constants.thermostatSystemModes[msg.data["systemMode"]];
      }
      if (msg.data.hasOwnProperty("pIHeatingDemand")) {
        result.pi_heating_demand = precisionRound(
          msg.data["pIHeatingDemand"],
          0
        );
      }
      if (msg.data.hasOwnProperty("minHeatSetpointLimit")) {
        result.min_heat_setpoint_limit =
          precisionRound(msg.data["minHeatSetpointLimit"], 2) / 100;
      }
      if (msg.data.hasOwnProperty("maxHeatSetpointLimit")) {
        result.max_heat_setpoint_limit =
          precisionRound(msg.data["maxHeatSetpointLimit"], 2) / 100;
      }
      if (msg.data.hasOwnProperty("absMinHeatSetpointLimit")) {
        result.abs_min_heat_setpoint_limit =
          precisionRound(msg.data["absMinHeatSetpointLimit"], 2) / 100;
      }
      if (msg.data.hasOwnProperty("absMaxHeatSetpointLimit")) {
        result.abs_max_heat_setpoint_limit =
          precisionRound(msg.data["absMaxHeatSetpointLimit"], 2) / 100;
      }
      if (msg.data.hasOwnProperty("pIHeatingDemand")) {
        result.running_state =
          msg.data["pIHeatingDemand"] >= 10 ? "heat" : "idle";
      }
      return result;
    },
  } satisfies Fz.Converter,
  ...
  sinope: {
    ...
    convert: (model, msg, publish, options, meta) => {
      ...
      if (msg.data.hasOwnProperty("GFCiStatus")) {
        ...
        result.gfci_status = utils.getFromLookup(
          msg.data["GFCiStatus"],
          lookup
        );
      }
      if (msg.data.hasOwnProperty("floorLimitStatus")) {
        const lookup = { 0: "off", 1: "on" };
        result.floor_limit_status = utils.getFromLookup(
          msg.data["floorLimitStatus"],
          lookup
        );
      }
      if (msg.data.hasOwnProperty("secondScreenBehavior")) {
        const lookup = { 0: "auto", 1: "setpoint", 2: "outdoor temp" };
        result.second_display_mode = utils.getFromLookup(
      ...
      if (msg.data.hasOwnProperty("outdoorTempToDisplayTimeout")) {
        ...
        result.enable_outdoor_temperature =
          msg.data["outdoorTempToDisplayTimeout"] === 12 ? "OFF" : "ON";
      }
      if (msg.data.hasOwnProperty("outdoorTempToDisplay")) {
        result.thermostat_outdoor_temperature =
          precisionRound(msg.data["outdoorTempToDisplay"], 2) / 100;
      }
      ...
      if (msg.data.hasOwnProperty("floorControlMode")) {
        ...
        result.floor_control_mode = utils.getFromLookup(
          msg.data["floorControlMode"],
          lookup
        );
      }
      if (msg.data.hasOwnProperty("ambiantMaxHeatSetpointLimit")) {
        result.ambiant_max_heat_setpoint =
          msg.data["ambiantMaxHeatSetpointLimit"] / 100.0;
      ...
      if (msg.data.hasOwnProperty("floorMinHeatSetpointLimit")) {
        result.floor_min_heat_setpoint =
          msg.data["floorMinHeatSetpointLimit"] / 100.0;
      ...
      if (msg.data.hasOwnProperty("floorMaxHeatSetpointLimit")) {
        result.floor_max_heat_setpoint =
          msg.data["floorMaxHeatSetpointLimit"] / 100.0;
      ...
      if (msg.data.hasOwnProperty("temperatureSensor")) {
        ...
        result.floor_temperature_sensor = utils.getFromLookup(
          msg.data["temperatureSensor"],
          lookup
        );
      }
      if (msg.data.hasOwnProperty("timeFormatToDisplay")) {
        const lookup = { 0: "24h", 1: "12h" };
        result.time_format = utils.getFromLookup(
          msg.data["timeFormatToDisplay"],
          lookup
        );
      }
      ...
      if (msg.data.hasOwnProperty("keypadLockout")) {
        ...
        result.keypad_lockout = utils.getFromLookup(
...
const tzLocal = {
  ...
  aux_cycle_output: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      await entity.write("hvacThermostat", {
        SinopeAuxCycleOutput: utils.getFromLookup(value, lookup),
      });
  ...
  enable_outdoor_temperature: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      if (value.toLowerCase() == "on") {
        ...
        await entity.write(
          "manuSpecificSinope",
          { outdoorTempToDisplayTimeout: 12 },
          manuSinope
        );
      }
      return {
        readAfterWriteTime: 250,
        state: { enable_outdoor_temperature: value },
      };
    },
    convertGet: async (entity, key, meta) => {
      await entity.read(
  ...
  thermostat_outdoor_temperature: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      if (number >= -99.5 && number <= 99.5) {
        await entity.write(
          "manuSpecificSinope",
          { outdoorTempToDisplay: number * 100 },
          manuSinope
        );
      }
  ...
  temperature_sensor: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      return {
        readAfterWriteTime: 250,
        state: { floor_temperature_sensor: value },
      };
    },
    convertGet: async (entity, key, meta) => {
  ...
  time_format: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      if (lookup.hasOwnProperty(value)) {
        await entity.write(
          "manuSpecificSinope",
          { timeFormatToDisplay: utils.getFromLookup(value, lookup) },
          manuSinope
        );
  ...
  keypad_lockout: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      await entity.write("manuSpecificSinope", {
        keypadLockout: utils.getFromLookup(value, lookup),
      });
...
const definitions: Definition[] = [
  {
    ...
    exposes: [
      ...
      e
        .enum("thermostat_occupancy", ea.ALL, ["unoccupied", "occupied"])
        .withDescription("Occupancy state of the thermostat"),
      e
        .enum("second_display_mode", ea.ALL, [
          "auto",
          "setpoint",
          "outdoor temp",
        ])
    ...
    whiteLabel: [
      {
        ...
        vendor: "Sinopé",
        description: "Zigbee smart floor heating thermostat",
        fingerprint: [{ modelID: "TH1320ZB-04" }],
      },
    ],
    fromZigbee: [
      fzLocal.thermostat,
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .enum("floor_control_mode", ea.ALL, ["ambiant", "floor"])
      ...
      e
        .enum("floor_temperature_sensor", ea.ALL, ["10k", "12k"])
        .withDescription("The floor sensor"),
      e
        .enum("main_cycle_output", ea.ALL, [
          "15_sec",
          "5_min",
          "10_min",
          "15_min",
      ...
      e
        .binary("pump_protection", ea.ALL, "ON", "OFF")
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .enum("keypad_lockout", ea.ALL, ["unlock", "lock"])
        .withDescription("Enables or disables the device’s buttons"),
      e
        .numeric("connected_load", ea.ALL)
        .withUnit("W")
