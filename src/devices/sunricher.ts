...
const definitions: Definition[] = [
  ...
  },
  {
    ...
    toZigbee: [],
    exposes: [
      e.action(["press_on", "press_off", "hold_on", "hold_off", "release"]),
    ],
  },
  {
    fingerprint: [
  ...
  {
    fingerprint: [
      { modelID: "GreenPower_2", ieeeAddr: /^0x00000000aaf.....$/ },
    ],
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .binary("away_mode", ea.ALL, "ON", "OFF")
        .withDescription("Enable/disable away mode"),
      e
        .binary("child_lock", ea.ALL, "UNLOCK", "LOCK")
      ...
      e.energy(),
      e
        .enum("lcd_brightness", ea.ALL, ["low", "mid", "high"])
        .withDescription(
          "OLED brightness when operating the buttons.  Default: Medium."
        ),
      e
        .enum("button_vibration_level", ea.ALL, ["off", "low", "high"])
      ...
      e
        .enum("sensor", ea.ALL, ["air", "floor", "both"])
        .withDescription(
          "The sensor used for heat control.  Default: Room Sensor."
        ),
      e
        .enum("powerup_status", ea.ALL, ["default", "last_status"])
        .withDescription(
      ...
      e
        .enum("mode_after_dry", ea.ALL, ["off", "manual", "auto", "away"])
        .withDescription("The mode after Dry Mode.  Default: Auto."),
      e
        .enum("temperature_display", ea.ALL, ["room", "floor"])
        .withDescription(
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      const options = {
        manufacturerCode:
          Zcl.ManufacturerCode.SHENZHEN_SUNRICHER_TECHNOLOGY_LTD,
      };
