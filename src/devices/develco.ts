  ...
  fz: {
    ...
    electrical_measurement: {
      ...
      convert: (model, msg, publish, options, meta) => {
        if (
          msg.data.rmsVoltage !== 0xffff &&
          msg.data.rmsCurrent !== 0xffff &&
          msg.data.activePower !== -0x8000
        ) {
          return fz.electrical_measurement.convert(
            model,
            msg,
            publish,
            options,
    ...
    total_power: {
      ...
      convert: (model, msg, publish, options, meta) => {
        ...
        if (
          msg.data.hasOwnProperty("totalActivePower") &&
          msg.data["totalActivePower"] !== -0x80000000
        ) {
          result[utils.postfixWithEndpointName("power", msg, model, meta)] =
            msg.data["totalActivePower"];
        }
        if (
          msg.data.hasOwnProperty("totalReactivePower") &&
          msg.data["totalReactivePower"] !== -0x80000000
        ) {
          result[
            utils.postfixWithEndpointName("power_reactive", msg, model, meta)
    ...
    device_temperature: {
      ...
      convert: (model, msg, publish, options, meta) => {
        if (msg.data.currentTemperature !== -0x8000) {
          return fz.device_temperature.convert(
            model,
            msg,
            publish,
            options,
    ...
    temperature: {
      ...
      convert: (model, msg, publish, options, meta) => {
        if (
          msg.data.measuredValue !== -0x8000 &&
          msg.data.measuredValue !== 0xffff
        ) {
    ...
    metering: {
      ...
      convert: (model, msg, publish, options, meta) => {
        if (
          msg.data.instantaneousDemand !== -0x800000 &&
          msg.data.currentSummDelivered?.[1] !== 0
        ) {
    ...
    interface_mode: {
      ...
      convert: (model, msg, publish, options, meta) => {
        ...
        if (msg.data.hasOwnProperty("develcoInterfaceMode")) {
          result[
            utils.postfixWithEndpointName("interface_mode", msg, model, meta)
          ] = constants.develcoInterfaceMode.hasOwnProperty(
    ...
    fault_status: {
      ...
      convert: (model, msg, publish, options, meta) => {
        ...
        if (msg.data.hasOwnProperty("reliability")) {
          ...
          result.reliability = utils.getFromLookup(
            msg.data["reliability"],
            lookup
          );
        }
    ...
    voc: {
      ...
      convert: (model, msg, publish, options, meta) => {
        ...
        const vocProperty = utils.postfixWithEndpointName(
          "voc",
          msg,
          model,
          meta
        ...
        let airQuality;
        const airQualityProperty = utils.postfixWithEndpointName(
          "air_quality",
          msg,
          model,
          meta
    ...
    voc_battery: {
      ...
      convert: async (model, msg, publish, options, meta) => {
         ...
         */
        const result = await fz.battery.convert(
          model,
          msg,
          publish,
          options,
    ...
    led_control: {
      ...
      convert: (model, msg, publish, options, meta) => {
        ...
        if (msg.data.hasOwnProperty("develcoLedControl")) {
          state["led_control"] = utils.getFromLookup(
            msg.data["develcoLedControl"],
    ...
    input: {
      ...
      convert: (model, msg, publish, options, meta) => {
        ...
        if (msg.data.hasOwnProperty("presentValue")) {
          ...
          result[utils.postfixWithEndpointName("input", msg, model, meta)] =
            value == 1;
        }
        return result;
      },
  ...
  tz: {
    pulse_configuration: {
      ...
      convertSet: async (entity, key, value, meta) => {
        ...
        return {
          ...
          state: { pulse_configuration: value },
        };
      },
    ...
    ias_occupancy_timeout: {
      ...
      convertSet: async (entity, key, value, meta) => {
        ...
        if (timeoutValue < 5) {
          logger.warning(
            `Minimum occupancy_timeout is 5, using 5 instead of ${timeoutValue}!`,
            NS
          );
          timeoutValue = 5;
        }
        await entity.write(
          "ssIasZone",
          { develcoAlarmOffDelay: timeoutValue },
          manufacturerOptions
        );
...
const definitions: Definition[] = [
  {
    ...
    fromZigbee: [
      fz.on_off,
      develco.fz.electrical_measurement,
      develco.fz.metering,
      develco.fz.device_temperature,
    ],
    toZigbee: [tz.on_off],
    ota: ota.zigbeeOTA,
    exposes: [
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await reporting.rmsVoltage(endpoint, {
        ...
        change: 400,
      }); // Limit reports to every 5m, or 4V
  ...
  },
  {
    ...
    exposes: [
      e
        ...
        .withUnit("W")
        .withDescription("Total active power"),
      e
        .numeric("power_reactive", ea.STATE)
        .withUnit("VAr")
        .withDescription("Total reactive power"),
      e.energy(),
      e.current(),
      e.voltage(),
      e.current_phase_b(),
    ...
    onEvent: async (type, data, device) => {
      if (
        ...
        data.endpoint.saveClusterAttributeKeyValue("seMetering", {
          divisor: 1000,
          multiplier: 1,
        });
      }
  ...
  },
  {
    ...
    whiteLabel: [
      {
        vendor: "Frient",
        model: "94430",
        description: "Smart Intelligent Smoke Alarm",
      },
      {
        vendor: "Cavius",
        model: "2103",
        description: "RF SMOKE ALARM, 5 YEAR 65MM",
      },
    ],
    fromZigbee: [
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await reporting.temperature(endpoint2, {
        min: constants.repInterval.MINUTE,
        max: constants.repInterval.MINUTES_10,
        change: 10,
      });
    ...
    exposes: [
      ...
      e
        ...
        .withValueMin(0)
        .withValueMax(600)
        .withDescription("Duration of Siren"),
      e
        .binary("alarm", ea.SET, "START", "OFF")
        .withDescription("Manual Start of Siren"),
      e
        .enum("reliability", ea.STATE, [
          "no_fault_detected",
          "unreliable_other",
          "process_error",
        ])
      ...
      e
        ...
        .withDescription("Indicates whether the device are in fault state"),
    ],
  },
  {
    ...
    whiteLabel: [
      {
        vendor: "Frient",
        model: "94431",
        description: "Smart Intelligent Heat Alarm",
      },
    ],
    fromZigbee: [
      develco.fz.temperature,
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await reporting.bind(endpoint38, coordinatorEndpoint, [
        "msTemperatureMeasurement",
      ]);
  ...
  },
  {
    ...
    fromZigbee: [
      ...
      fz.battery,
      develco.fz.led_control,
      develco.fz.ias_occupancy_timeout,
    ],
    extend: [illuminance()],
    ...
    exposes: (device, options) => {
      ...
      if (
        ...
        Number(device.softwareBuildID.split(".")[0]) >= 3
      ) {
        dynExposes.push(
          e
      ...
      if (
        device &&
        device.softwareBuildID &&
        Number(device.softwareBuildID.split(".")[0]) >= 4
      ) {
        dynExposes.push(
          e
            .enum("led_control", ea.ALL, [
              "off",
              "fault_only",
              "motion_only",
              "both",
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await reporting.bind(endpoint35, coordinatorEndpoint, ["genPowerCfg"]);
      await reporting.batteryVoltage(endpoint35, {
        min: constants.repInterval.HOUR,
        max: 43200,
        change: 100,
      });
  ...
  },
  {
    ...
    fromZigbee: [
      develco.fz.metering,
      develco.fz.pulse_configuration,
      develco.fz.interface_mode,
    ],
    toZigbee: [
      develco.tz.pulse_configuration,
      develco.tz.interface_mode,
      develco.tz.current_summation,
    ],
    endpoint: (device) => {
      return { default: 2 };
    },
    ...
    exposes: [
      ...
      e
        .binary("check_meter", ea.STATE, true, false)
        .withDescription(
  ...
  },
  {
    ...
    exposes: [
      ...
      e
        .binary("alarm", ea.SET, "START", "OFF")
        .withDescription("Manual start of the siren"),
    ],
  },
  {
    ...
    exposes: [
      ...
      e
        .numeric("action_transaction", ea.STATE)
        .withDescription("Last action transaction number."),
      e
        .text("action_zone", ea.STATE)
        .withDescription("Alarm zone. Default value 23"),
      e.action([
        "disarm",
        "arm_day_zones",
        "arm_night_zones",
    ...
    onEvent: async (type, data, device) => {
      if (
        ...
        const payload = {
          panelstatus: globalStore.getValue(
            device.getEndpoint(44),
            "panelStatus"
          ),
          secondsremain: 0x00,
          audiblenotif: 0x00,
  ...
  },
  {
    ...
    exposes: [
      e
        .binary("input", ea.STATE_GET, true, false)
        .withEndpoint("l1")
        .withDescription("State of input 1"),
      e
        .binary("input", ea.STATE_GET, true, false)
        .withEndpoint("l2")
        .withDescription("State of input 2"),
      e
        .binary("input", ea.STATE_GET, true, false)
        .withEndpoint("l3")
        .withDescription("State of input 3"),
      e
        .binary("input", ea.STATE_GET, true, false)
        .withEndpoint("l4")
        .withDescription("State of input 4"),
      e
        .switch_()
        .withState("state", true, "On/off state of switch 1")
        .withEndpoint("l11"),
      e
        .switch_()
        .withState("state", true, "On/off state of switch 2")
        .withEndpoint("l12"),
    ],
    configure: async (device, coordinatorEndpoint) => {
      ...
      await reporting.bind(ep6, coordinatorEndpoint, [
        "genOnOff",
        "genBinaryInput",
      ]);
