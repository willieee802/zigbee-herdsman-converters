...
const tzLocal = {
  quiet_fan: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      await entity.write(
        "hvacFanCtrl",
        { 0x1000: { value: value ? 1 : 0, type: 0x10 } },
  ...
  preset: {
    ...
    convertSet: async (entity, key, value, meta) => {
      ...
      await entity.write(
        "hvacThermostat",
        { 0x4275: { value: activity, type: 0x30 } },
        { manufacturerCode: Zcl.ManufacturerCode.ATLANTIC_GROUP }
      );
      await entity.write("hvacThermostat", { programingOperMode: eco });
      await entity.write(
        "hvacThermostat",
        { 0x4270: { value: boost, type: 0x10 } },
        { manufacturerCode: Zcl.ManufacturerCode.ATLANTIC_GROUP }
      );
...
const definitions: Definition[] = [
  {
    ...
    exposes: [
      ...
      e
        .binary("quiet_fan", ea.STATE_SET, true, false)
        .withDescription("Fan quiet mode"),
      e
        .enum(
          "ac_louver_position",
          ea.STATE_SET,
