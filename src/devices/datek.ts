...
const definitions: Definition[] = [
  ...
  },
  {
    ...
    exposes: [
      ...
      e.illuminance(),
      e
        .binary("led_on_motion", ea.ALL, true, false)
        .withDescription("Enable/disable LED on motion"),
      e
  ...
  },
  {
    ...
    configure: async (device, coordinatorEndpoint) => {
      ...
      await endpoint.read("closuresDoorLock", [
        "lockState",
        "soundVolume",
        "doorState",
      ]);
      await endpoint.read(
        "closuresDoorLock",
        [0x4000, 0x4001, 0x4003, 0x4004, 0x4005],
        options
      );
    ...
    onEvent: async (type, data, device) => {
      ...
      if (
        ...
        (data.data.programeventsrc === undefined ||
          constants.lockSourceName[data.data.programeventsrc] != "rf")
      ) {
        await device.endpoints[0].command(
          "closuresDoorLock",
          "getPinCode",
    ...
    exposes: [
      ...
      e.lock_action_user(),
      e
        .enum("sound_volume", ea.ALL, constants.lockSoundVolume)
        .withDescription("Sound volume of the lock"),
      e
        .binary("master_pin_mode", ea.ALL, true, false)
        .withDescription("Allow Master PIN Unlock"),
      e
        .binary("rfid_enable", ea.ALL, true, false)
        .withDescription("Allow RFID to Unlock"),
      e
        .binary("relock_enabled", ea.ALL, true, false)
        .withDescription("Allow Auto Re-Lock"),
      e
        .enum("lock_mode", ea.ALL, [
          "auto_off_away_off",
          "auto_on_away_off",
          "auto_off_away_on",
          "auto_on_away_on",
      ...
      e
        .enum("service_mode", ea.ALL, [
          "deactivated",
          "random_pin_1x_use",
          "random_pin_24_hours",
        ])
        .withDescription("Service Mode of the Lock"),
    ],
  },
  {
