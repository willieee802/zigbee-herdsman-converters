...
const fzLocal = {
    ...
    eglo99099_command_off: {
        ...
        convert: (model, msg, publish, options, meta) => {
            return setActionGroup(
                fz.command_off.convert(model, msg as unknown as Fz.Message<"genOnOff", undefined, "commandOff">, publish, options, meta),
                msg.groupID,
            );
        },
    ...
    eglo99099_command_move_to_color_temp: {
        ...
        convert: (model, msg, publish, options, meta) => {
            globalStore.putValue(msg.endpoint, "last_non_on_action", Date.now());
            return setActionGroup(
                fz.command_move_to_color_temp.convert(
                    model,
                    msg as unknown as Fz.Message<"lightingColorCtrl", undefined, "commandMoveToColorTemp">,
                    publish,
                    options,
                    meta,
                ),
    ...
    eglo99099_command_recall: {
        ...
        convert: (model, msg, publish, options, meta) => {
            return setActionGroup(
                fz.command_recall.convert(model, msg as unknown as Fz.Message<"genScenes", undefined, "commandRecall">, publish, options, meta),
                msg.groupID,
            );
        },
