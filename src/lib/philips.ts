...
export interface PhilipsMsOccupancySensing {
    attributes: {
...
const philipsModernExtend = {
    ...
    addPhilipsMsOccupancySensingCluster: () =>
        modernExtend.deviceAddCustomCluster("msOccupancySensing", {
...
const philipsTz = {
    ...
    hue_motion_sensitivity: {
        ...
        convertGet: async (entity, key, meta) => {
            await entity.read<"msOccupancySensing", PhilipsMsOccupancySensing>("msOccupancySensing", ["motionSensitivity"], manufacturerOptions);
        },
    } satisfies Tz.Converter,
    hue_motion_led_indication: {
        ...
        convertGet: async (entity, key, meta) => {
            await entity.read<"genBasic", PhilipsGenBasic>("genBasic", ["ledIndication"], manufacturerOptions);
        },
    } satisfies Tz.Converter,
    hue_wall_switch_device_mode: {
        ...
        convertGet: async (entity, key, meta) => {
            await entity.read<"genBasic", PhilipsGenBasic>("genBasic", ["deviceMode"], manufacturerOptions);
        },
    } satisfies Tz.Converter,
};
...
const philipsFz = {
    ...
    } satisfies Fz.Converter<"genBasic", PhilipsGenBasic, ["attributeReport", "readResponse"]>,
    hue_motion_sensitivity: {
    ...
    } satisfies Fz.Converter<"msOccupancySensing", PhilipsMsOccupancySensing, ["attributeReport", "readResponse"]>,
    hue_wall_switch_device_mode: {
        cluster: "genBasic",
        type: ["attributeReport", "readResponse"],
        convert: (model, msg, publish, options, meta) => {
